...
class EnhanceAsynchronousChannelGroup extends AsynchronousChannelGroup {
  ...
  private static final Consumer<SelectionKey> readConsumer = selectionKey -> ((EnhanceAsynchronousSocketChannel) selectionKey.attachment())
      .doRead(true, false);
   ...
   */
  protected EnhanceAsynchronousChannelGroup(AsynchronousChannelProvider provider, ExecutorService readExecutorService, int threadNum)
      throws IOException {
    super(provider);
